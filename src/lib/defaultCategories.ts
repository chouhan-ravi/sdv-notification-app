...
import { DynamicCategory, DynamicNotificationKey } from '../types';
...
export const DEFAULT_DYNAMIC_NOTIFICATION_KEYS: DynamicNotificationKey[] = [
...
export const DEFAULT_DYNAMIC_RULE_KEYS = DEFAULT_DYNAMIC_NOTIFICATION_KEYS;
