...
export default function AuditLog({ logs, onLoadLogIntoSimulator, onClearLogs }: AuditLogProps) {
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-lg flex flex-col h-full min-h-[300px]">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-slate-850 mb-3">
        ...
        {logs.length > 0 && (
          <button
            onClick={onClearLogs}
            className="text-[10px] text-rose-400 hover:text-rose-300 hover:bg-rose-950/20 px-2 py-1 rounded transition flex items-center space-x-1 border border-rose-950"
          >
